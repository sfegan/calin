/*
   ...
   calin/math/fftw_codelet_512d.hpp -- Stephen Fegan -- 2025-10-19

   Container for FFTW codelets for AVX512 double
...
namespace calin::math::fftw_util {
   template class FFTWCodelet<calin::util::vcl::VCL512DoubleReal>;
}
