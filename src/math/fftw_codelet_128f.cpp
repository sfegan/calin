/*
   ...
   calin/math/fftw_codelet_128f.hpp -- Stephen Fegan -- 2025-10-19

   Container for FFTW codelets for SSE float
...
namespace calin::math::fftw_util {
   template class FFTWCodelet<calin::util::vcl::VCL128FloatReal>;
}
