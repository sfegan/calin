/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cf.native -n 40 -standalone -fma -generic-arith -compact -name dft_codelet_r2hc_40 */
 ...
 */
void dft_codelet_r2hc_40(const R * R0, const R * R1, R * Cr, R * Ci)
{
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    
    {
      ...
      }
      {
        ...
        T2r = ADD(T2j, T2k);
        T2s = ADD(T2q, T2r);
        Cr[WSCR(10)] = SUB(Tj, TC);
        Ci[WSCI(10)] = SUB(T2r, T2q);
        Cr[WSCR(20)] = SUB(T2p, T2s);
        Cr[0] = ADD(T2p, T2s);
      }
      {
        ...
        T2m = SUB(T2i, T2l);
        T2o = ADD(T2i, T2l);
        Ci[WSCI(5)] = NEG(FNMS(KP707106781, T2m, T2f));
        Cr[WSCR(5)] = FNMS(KP707106781, T2o, T2n);
        Ci[WSCI(15)] = FMA(KP707106781, T2m, T2f);
        Cr[WSCR(15)] = FMA(KP707106781, T2o, T2n);
      }
      {
        ...
        Ci[WSCI(6)] = FMA(KP951056516, T1C, T1n);
        Ci[WSCI(4)] = MUL(KP951056516, ADD(T2Z, T32));
        Ci[WSCI(16)] = MUL(KP951056516, SUB(T32, T2Z));
        Ci[WSCI(14)] = FNMS(KP951056516, T1C, T1n);
        T1R = ADD(T1J, T1Q);
        Cr[WSCR(4)] = SUB(T1R, T1S);
        Cr[WSCR(16)] = ADD(T1R, T1S);
        {
          E T33, T2X, T2Y, T2R, T2S;
          T33 = SUB(T1J, T1Q);
          Cr[WSCR(14)] = FNMS(KP951056516, T34, T33);
          Cr[WSCR(6)] = FMA(KP951056516, T34, T33);
          T2X = FNMS(KP951056516, T2u, T2t);
          T2Y = ADD(T2V, T2U);
          Cr[WSCR(11)] = FNMS(KP707106781, T2Y, T2X);
          Cr[WSCR(9)] = FMA(KP707106781, T2Y, T2X);
          T2R = FMA(KP951056516, T2Q, T2P);
          T2S = SUB(T2N, T2E);
          Ci[WSCI(9)] = NEG(FNMS(KP707106781, T2S, T2R));
          Ci[WSCI(11)] = FMA(KP707106781, T2S, T2R);
          {
            E T2v, T2O, T2T, T2W;
            T2v = FMA(KP951056516, T2u, T2t);
            T2O = ADD(T2E, T2N);
            Cr[WSCR(19)] = FNMS(KP707106781, T2O, T2v);
            Cr[WSCR(1)] = FMA(KP707106781, T2O, T2v);
            T2T = FNMS(KP951056516, T2Q, T2P);
            T2W = SUB(T2U, T2V);
            Ci[WSCI(1)] = NEG(FNMS(KP707106781, T2W, T2T));
            Ci[WSCI(19)] = FMA(KP707106781, T2W, T2T);
          }
        }
      }
      {
        ...
        Ci[WSCI(2)] = FMA(KP951056516, T26, T1Z);
        Ci[WSCI(18)] = FNMS(KP951056516, T26, T1Z);
        Ci[WSCI(12)] = MUL(KP951056516, ADD(T3y, T3x));
        Ci[WSCI(8)] = MUL(KP951056516, SUB(T3x, T3y));
        T3t = SUB(T29, T2c);
        Cr[WSCR(18)] = FNMS(KP951056516, T3w, T3t);
        Cr[WSCR(2)] = FMA(KP951056516, T3w, T3t);
        {
          E T2d, T3n, T3q, T3l, T3m;
          T2d = ADD(T29, T2c);
          Cr[WSCR(12)] = SUB(T2d, T2e);
          Cr[WSCR(8)] = ADD(T2d, T2e);
          T3n = FNMS(KP951056516, T36, T35);
          T3q = SUB(T3o, T3p);
          Ci[WSCI(7)] = FMA(KP707106781, T3q, T3n);
          Ci[WSCI(13)] = NEG(FNMS(KP707106781, T3q, T3n));
          T3l = FMA(KP951056516, T3k, T3j);
          T3m = ADD(T3h, T3c);
          Cr[WSCR(13)] = FNMS(KP707106781, T3m, T3l);
          Cr[WSCR(7)] = FMA(KP707106781, T3m, T3l);
          {
            E T37, T3i, T3r, T3s;
            T37 = FMA(KP951056516, T36, T35);
            T3i = SUB(T3c, T3h);
            Ci[WSCI(3)] = FMA(KP707106781, T3i, T37);
            Ci[WSCI(17)] = NEG(FNMS(KP707106781, T3i, T37));
            T3r = FNMS(KP951056516, T3k, T3j);
            T3s = ADD(T3o, T3p);
            Cr[WSCR(3)] = FNMS(KP707106781, T3s, T3r);
            Cr[WSCR(17)] = FMA(KP707106781, T3s, T3r);
          }
        }
      }
    }
