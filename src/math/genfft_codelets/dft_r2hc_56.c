/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cf.native -n 56 -standalone -fma -generic-arith -compact -name dft_codelet_r2hc_56 */
 ...
 */
void dft_codelet_r2hc_56(const R * R0, const R * R1, R * Cr, R * Ci)
{
  ...
  DK(KP356895867, +0.356895867892209443894399510021300583399127187);
  {
    
    {
      ...
      }
      {
        ...
        T3O = ADD(T3H, T3I);
        T3Q = ADD(T3N, T3O);
        Cr[WSCR(14)] = SUB(Tn, TK);
        Ci[WSCI(14)] = SUB(T3N, T3O);
        Cr[WSCR(28)] = SUB(T3P, T3Q);
        Cr[0] = ADD(T3P, T3Q);
      }
      {
        ...
        T3K = SUB(T3G, T3J);
        T3M = ADD(T3G, T3J);
        Ci[WSCI(7)] = FMA(KP707106781, T3K, T3D);
        Cr[WSCR(7)] = FMA(KP707106781, T3M, T3L);
        Ci[WSCI(21)] = NEG(FNMS(KP707106781, T3K, T3D));
        Cr[WSCR(21)] = FNMS(KP707106781, T3M, T3L);
      }
      {
        ...
        Ci[WSCI(10)] = FMA(KP974927912, T2g, T1T);
        Ci[WSCI(18)] = FNMS(KP974927912, T2g, T1T);
        Ci[WSCI(24)] = MUL(KP974927912, ADD(T5G, T5F));
        Ci[WSCI(4)] = MUL(KP974927912, SUB(T5F, T5G));
        T5B = SUB(TR, TY);
        Cr[WSCR(18)] = FNMS(KP974927912, T5E, T5B);
        Cr[WSCR(10)] = FMA(KP974927912, T5E, T5B);
        {
          E TZ, T5z, T5A, T5t, T5u;
          TZ = ADD(TR, TY);
          Cr[WSCR(4)] = SUB(TZ, T1S);
          Cr[WSCR(24)] = ADD(TZ, T1S);
          T5z = FNMS(KP974927912, T5a, T59);
          T5A = SUB(T5x, T5w);
          Ci[WSCI(11)] = FMA(KP707106781, T5A, T5z);
          Ci[WSCI(17)] = NEG(FNMS(KP707106781, T5A, T5z));
          T5t = FMA(KP974927912, T5s, T5r);
          T5u = ADD(T5p, T5i);
          Cr[WSCR(11)] = FNMS(KP707106781, T5u, T5t);
          Cr[WSCR(17)] = FMA(KP707106781, T5u, T5t);
          {
            E T5b, T5q, T5v, T5y;
            T5b = FMA(KP974927912, T5a, T59);
            T5q = SUB(T5i, T5p);
            Ci[WSCI(3)] = FMA(KP707106781, T5q, T5b);
            Ci[WSCI(25)] = NEG(FNMS(KP707106781, T5q, T5b));
            T5v = FNMS(KP974927912, T5s, T5r);
            T5y = ADD(T5w, T5x);
            Cr[WSCR(3)] = FNMS(KP707106781, T5y, T5v);
            Cr[WSCR(25)] = FMA(KP707106781, T5y, T5v);
          }
        }
      }
      {
        ...
        Ci[WSCI(2)] = FMA(KP974927912, T2G, T2v);
        Ci[WSCI(26)] = FNMS(KP974927912, T2G, T2v);
        Ci[WSCI(16)] = MUL(KP974927912, ADD(T4O, T4N));
        Ci[WSCI(12)] = MUL(KP974927912, SUB(T4N, T4O));
        T4B = SUB(T2N, T2U);
        Cr[WSCR(26)] = FNMS(KP974927912, T4M, T4B);
        Cr[WSCR(2)] = FMA(KP974927912, T4M, T4B);
        {
          E T2V, T57, T58, T51, T52;
          T2V = ADD(T2N, T2U);
          Cr[WSCR(12)] = SUB(T2V, T2W);
          Cr[WSCR(16)] = ADD(T2V, T2W);
          T57 = FNMS(KP974927912, T4Q, T4P);
          T58 = ADD(T54, T55);
          Cr[WSCR(19)] = FNMS(KP707106781, T58, T57);
          Cr[WSCR(9)] = FMA(KP707106781, T58, T57);
          T51 = FMA(KP974927912, T50, T4Z);
          T52 = SUB(T4X, T4U);
          Ci[WSCI(9)] = NEG(FNMS(KP707106781, T52, T51));
          Ci[WSCI(19)] = FMA(KP707106781, T52, T51);
          {
            E T4R, T4Y, T53, T56;
            T4R = FMA(KP974927912, T4Q, T4P);
            T4Y = ADD(T4U, T4X);
            Cr[WSCR(5)] = FNMS(KP707106781, T4Y, T4R);
            Cr[WSCR(23)] = FMA(KP707106781, T4Y, T4R);
            T53 = FNMS(KP974927912, T50, T4Z);
            T56 = SUB(T54, T55);
            Ci[WSCI(5)] = NEG(FNMS(KP707106781, T56, T53));
            Ci[WSCI(23)] = FMA(KP707106781, T56, T53);
          }
        }
      }
      {
        ...
        Ci[WSCI(6)] = FMA(KP974927912, T3m, T3b);
        Ci[WSCI(22)] = FNMS(KP974927912, T3m, T3b);
        Ci[WSCI(20)] = MUL(KP974927912, SUB(T4A, T4z));
        Ci[WSCI(8)] = MUL(KP974927912, ADD(T4z, T4A));
        T4v = SUB(T3t, T3A);
        Cr[WSCR(22)] = FNMS(KP974927912, T4y, T4v);
        Cr[WSCR(6)] = FMA(KP974927912, T4y, T4v);
        {
          E T3B, T4p, T4s, T4n, T4o;
          T3B = ADD(T3t, T3A);
          Cr[WSCR(20)] = SUB(T3B, T3C);
          Cr[WSCR(8)] = ADD(T3B, T3C);
          T4p = FNMS(KP974927912, T3S, T3R);
          T4s = SUB(T4q, T4r);
          Ci[WSCI(1)] = NEG(FNMS(KP707106781, T4s, T4p));
          Ci[WSCI(27)] = FMA(KP707106781, T4s, T4p);
          T4n = FMA(KP974927912, T4m, T4l);
          T4o = ADD(T46, T4j);
          Cr[WSCR(27)] = FNMS(KP707106781, T4o, T4n);
          Cr[WSCR(1)] = FMA(KP707106781, T4o, T4n);
          {
            E T3T, T4k, T4t, T4u;
            T3T = FMA(KP974927912, T3S, T3R);
            T4k = SUB(T46, T4j);
            Ci[WSCI(13)] = NEG(FNMS(KP707106781, T4k, T3T));
            Ci[WSCI(15)] = FMA(KP707106781, T4k, T3T);
            T4t = FNMS(KP974927912, T4m, T4l);
            T4u = ADD(T4r, T4q);
            Cr[WSCR(13)] = FNMS(KP707106781, T4u, T4t);
            Cr[WSCR(15)] = FMA(KP707106781, T4u, T4t);
          }
        }
      }
    }
