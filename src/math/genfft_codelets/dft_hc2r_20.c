/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cb.native -n 20 -sign 1 -standalone -fma -generic-arith -compact -name dft_codelet_hc2r_20 */
 ...
 */
void dft_codelet_hc2r_20(R * R0, R * R1, const R * Cr, const R * Ci)
{
  ...
  DK(KP2_000000000, +2.000000000000000000000000000000000000000000000);
  {
    
    {
      ...
      {
        E T8, Ts, TR, T19, Tb, T18, Tv, TS, Tf, Tx, TM, T1c, Ti, T1b,
         TA;
        E TN;
        {
          E T6, T7, TP, TQ;
      ...
      R0[WSR(5)] = FMA(KP2_000000000, Tk, T5);
      R1[WSR(7)] = FMA(KP2_000000000, TC, Tr);
      R1[WSR(2)] = FMA(KP2_000000000, TG, TD);
      R0[0] = FMA(KP2_000000000, To, Tl);
      {
        ...
        R0[WSR(9)] = FNMS(KP1_902113032, TU, TJ);
        R0[WSR(7)] = FMA(KP1_902113032, TW, TV);
        R0[WSR(1)] = FMA(KP1_902113032, TU, TJ);
        R0[WSR(3)] = FNMS(KP1_902113032, TW, TV);
      }
      {
        ...
        R1[WSR(8)] = FMA(KP1_902113032, T1g, T1f);
        R1[WSR(4)] = FMA(KP1_902113032, T1e, T17);
        R1[WSR(6)] = FNMS(KP1_902113032, T1g, T1f);
      }
      {
        ...
        R1[WSR(1)] = FNMS(KP1_902113032, T1m, T1j);
        R1[WSR(9)] = FMA(KP1_902113032, T1o, T1n);
        R1[WSR(3)] = FMA(KP1_902113032, T1m, T1j);
        R1[WSR(5)] = FNMS(KP1_902113032, T1o, T1n);
      }
      {
        ...
        R0[WSR(8)] = FNMS(KP1_902113032, T12, TZ);
        R0[WSR(6)] = FMA(KP1_902113032, T14, T13);
        R0[WSR(2)] = FMA(KP1_902113032, T12, TZ);
        R0[WSR(4)] = FNMS(KP1_902113032, T14, T13);
      }
    }
  }
}
