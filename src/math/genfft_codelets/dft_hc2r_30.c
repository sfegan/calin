/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cb.native -n 30 -sign 1 -standalone -fma -generic-arith -compact -name dft_codelet_hc2r_30 */
 ...
 */
void dft_codelet_hc2r_30(R * R0, R * R1, const R * Cr, const R * Ci)
{
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    
    {
      ...
      }
      {
        ...
        R1[WSR(7)] = FNMS(KP2_000000000, Tw, Tv);
        R0[WSR(10)] = FMA(KP1_732050807, T1U, T1T);
        R0[WSR(5)] = FNMS(KP1_732050807, T1U, T1T);
        R1[WSR(2)] = FMA(KP1_732050807, T1S, T1H);
        R1[WSR(12)] = FNMS(KP1_732050807, T1S, T1H);
      }
      {
        ...
        R0[WSR(9)] = FMA(KP2_000000000, T1w, T1p);
        R0[WSR(6)] = FMA(KP2_000000000, T1E, T1B);
        R1[WSR(13)] = FNMS(KP2_000000000, T1G, T1F);
        R1[WSR(1)] = FNMS(KP2_000000000, T1y, T1x);
        {
          E T2j, T2q, T2t, T2w;
          T2j = SUB(T1B, T1E);
          T2q = SUB(T2m, T2p);
          R0[WSR(11)] = FNMS(KP1_732050807, T2q, T2j);
          R0[WSR(1)] = FMA(KP1_732050807, T2q, T2j);
          T2t = SUB(T1p, T1w);
          T2w = SUB(T2u, T2v);
          R0[WSR(14)] = FNMS(KP1_732050807, T2w, T2t);
          R0[WSR(4)] = FMA(KP1_732050807, T2w, T2t);
        }
        {
          E T2x, T2y, T2r, T2s;
          T2x = ADD(T1x, T1y);
          T2y = ADD(T2u, T2v);
          R1[WSR(6)] = FNMS(KP1_732050807, T2y, T2x);
          R1[WSR(11)] = FMA(KP1_732050807, T2y, T2x);
          T2r = ADD(T1F, T1G);
          T2s = ADD(T2m, T2p);
          R1[WSR(3)] = FNMS(KP1_732050807, T2s, T2r);
          R1[WSR(8)] = FMA(KP1_732050807, T2s, T2r);
        }
      }
      {
        ...
        R0[WSR(3)] = FMA(KP2_000000000, T18, TL);
        R0[WSR(12)] = FMA(KP2_000000000, T1g, T1d);
        R1[WSR(4)] = FNMS(KP2_000000000, T1i, T1h);
        R1[WSR(10)] = FNMS(KP2_000000000, T1a, T19);
        {
          E T1V, T2a, T2d, T2g;
          T1V = SUB(TL, T18);
          T2a = SUB(T22, T29);
          R0[WSR(8)] = FNMS(KP1_732050807, T2a, T1V);
          R0[WSR(13)] = FMA(KP1_732050807, T2a, T1V);
          T2d = SUB(T1d, T1g);
          T2g = SUB(T2e, T2f);
          R0[WSR(2)] = FNMS(KP1_732050807, T2g, T2d);
          R0[WSR(7)] = FMA(KP1_732050807, T2g, T2d);
        }
        {
          E T2h, T2i, T2b, T2c;
          T2h = ADD(T1h, T1i);
          T2i = ADD(T2e, T2f);
          R1[WSR(9)] = FNMS(KP1_732050807, T2i, T2h);
          R1[WSR(14)] = FMA(KP1_732050807, T2i, T2h);
          T2b = ADD(T19, T1a);
          T2c = ADD(T22, T29);
          R1[0] = FNMS(KP1_732050807, T2c, T2b);
          R1[WSR(5)] = FMA(KP1_732050807, T2c, T2b);
        }
      }
    }
  }
