/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cf.native -n 48 -standalone -fma -generic-arith -compact -name dft_codelet_r2hc_48 */
 ...
 */
void dft_codelet_r2hc_48(const R * R0, const R * R1, R * Cr, R * Ci)
{
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    
    {
      ...
      }
      {
        ...
        T2G = ADD(T2z, T2A);
        T2I = ADD(T2F, T2G);
        Cr[WSCR(12)] = SUB(Tn, TK);
        Ci[WSCI(12)] = SUB(T2F, T2G);
        Cr[WSCR(24)] = SUB(T2H, T2I);
        Cr[0] = ADD(T2H, T2I);
      }
      {
        ...
        T2C = ADD(T2y, T2B);
        T2E = SUB(T2B, T2y);
        Cr[WSCR(6)] = FNMS(KP707106781, T2C, T2v);
        Ci[WSCI(6)] = FMA(KP707106781, T2E, T2D);
        Cr[WSCR(18)] = FMA(KP707106781, T2C, T2v);
        Ci[WSCI(18)] = NEG(FNMS(KP707106781, T2E, T2D));
      }
      {
        ...
        Cr[WSCR(21)] = FNMS(KP923879532, T2k, T25);
        Ci[WSCI(21)] = NEG(FNMS(KP923879532, T2s, T2p));
        Cr[WSCR(3)] = FMA(KP923879532, T2k, T25);
        Ci[WSCI(3)] = FMA(KP923879532, T2s, T2p);
        Ci[WSCI(9)] = NEG(FNMS(KP923879532, T2o, T2n));
        Cr[WSCR(9)] = FNMS(KP923879532, T2u, T2t);
        Ci[WSCI(15)] = FMA(KP923879532, T2o, T2n);
        Cr[WSCR(15)] = FMA(KP923879532, T2u, T2t);
      }
      {
        ...
        }
        {
          E T42, T4c, T46, T4a;
          T42 = SUB(T3W, T41);
          Ci[WSCI(10)] = FMA(KP707106781, T42, T3R);
          Ci[WSCI(14)] = NEG(FNMS(KP707106781, T42, T3R));
          T4c = ADD(T49, T48);
          Cr[WSCR(10)] = FNMS(KP707106781, T4c, T4b);
          Cr[WSCR(14)] = FMA(KP707106781, T4c, T4b);
          T46 = ADD(T3W, T41);
          Cr[WSCR(22)] = FNMS(KP707106781, T46, T45);
          Cr[WSCR(2)] = FMA(KP707106781, T46, T45);
          T4a = SUB(T48, T49);
          Ci[WSCI(2)] = FMA(KP707106781, T4a, T47);
          Ci[WSCI(22)] = NEG(FNMS(KP707106781, T4a, T47));
        }
      }
      {
        ...
        Ci[WSCI(4)] = FMA(KP866025403, T1K, T1v);
        Cr[WSCR(4)] = FMA(KP866025403, T4g, T4d);
        Ci[WSCI(20)] = FNMS(KP866025403, T1K, T1v);
        Cr[WSCR(20)] = FNMS(KP866025403, T4g, T4d);
        Cr[WSCR(8)] = SUB(T1Z, T20);
        Ci[WSCI(8)] = MUL(KP866025403, SUB(T4h, T4i));
        Cr[WSCR(16)] = ADD(T1Z, T20);
        Ci[WSCI(16)] = MUL(KP866025403, ADD(T4i, T4h));
      }
      {
        ...
        }
        {
          ...
          T3g = SUB(T34, T3f);
          Ci[WSCI(7)] = FMA(KP923879532, T3g, T2T);
          Ci[WSCI(17)] = NEG(FNMS(KP923879532, T3g, T2T));
          T3t = FMA(KP707106781, T3m, T3j);
          T3u = ADD(T3r, T3q);
          Cr[WSCR(7)] = FNMS(KP923879532, T3u, T3t);
          Cr[WSCR(17)] = FMA(KP923879532, T3u, T3t);
        }
        {
          E T3n, T3o, T3p, T3s;
          T3n = FNMS(KP707106781, T3m, T3j);
          T3o = ADD(T34, T3f);
          Cr[WSCR(19)] = FNMS(KP923879532, T3o, T3n);
          Cr[WSCR(5)] = FMA(KP923879532, T3o, T3n);
          T3p = FNMS(KP707106781, T2S, T2L);
          T3s = SUB(T3q, T3r);
          Ci[WSCI(5)] = NEG(FNMS(KP923879532, T3s, T3p));
          Ci[WSCI(19)] = FMA(KP923879532, T3s, T3p);
        }
        {
          E T3x, T3E, T3N, T3O;
          T3x = FNMS(KP707106781, T3w, T3v);
          T3E = SUB(T3A, T3D);
          Ci[WSCI(1)] = NEG(FNMS(KP923879532, T3E, T3x));
          Ci[WSCI(23)] = FMA(KP923879532, T3E, T3x);
          T3N = FMA(KP707106781, T3G, T3F);
          T3O = ADD(T3K, T3L);
          Cr[WSCR(23)] = FNMS(KP923879532, T3O, T3N);
          Cr[WSCR(1)] = FMA(KP923879532, T3O, T3N);
        }
        {
          E T3H, T3I, T3J, T3M;
          T3H = FNMS(KP707106781, T3G, T3F);
          T3I = ADD(T3A, T3D);
          Cr[WSCR(13)] = FNMS(KP923879532, T3I, T3H);
          Cr[WSCR(11)] = FMA(KP923879532, T3I, T3H);
          T3J = FMA(KP707106781, T3w, T3v);
          T3M = SUB(T3K, T3L);
          Ci[WSCI(11)] = FMA(KP923879532, T3M, T3J);
          Ci[WSCI(13)] = NEG(FNMS(KP923879532, T3M, T3J));
        }
      }
    }
  }
