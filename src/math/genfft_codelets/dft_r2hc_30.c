/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cf.native -n 30 -standalone -fma -generic-arith -compact -name dft_codelet_r2hc_30 */
 ...
 */
void dft_codelet_r2hc_30(const R * R0, const R * R1, R * Cr, R * Ci)
{
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    
    {
      ...
      }
      {
        ...
        T2t = SUB(T2r, T2s);
        T2v = ADD(T2r, T2s);
        Ci[WSCI(5)] = MUL(KP866025403, SUB(T2n, T2q));
        Cr[WSCR(5)] = FNMS(KP500000000, T2u, T2t);
        Cr[WSCR(15)] = ADD(T2t, T2u);
        Ci[WSCI(10)] = MUL(KP866025403, SUB(T2x, T2w));
        Cr[WSCR(10)] = FNMS(KP500000000, T2y, T2v);
        Cr[0] = ADD(T2v, T2y);
      }
      {
        ...
        Ci[WSCI(12)] = MUL(KP951056516, ADD(TR, TY));
        Cr[WSCR(12)] = ADD(T2h, T2i);
        Ci[WSCI(3)] = MUL(KP951056516, ADD(TZ, T12));
        Cr[WSCR(3)] = ADD(T21, T28);
        Ci[WSCI(7)] = NEG(MUL(KP951056516, FNMS(KP910592997, T2c, T2b)));
        Ci[WSCI(8)] = NEG(MUL(KP951056516, FNMS(KP910592997, T2g, T2d)));
        Ci[WSCI(2)] = MUL(KP951056516, FMA(KP910592997, T2g, T2d));
        Ci[WSCI(13)] = MUL(KP951056516, FMA(KP910592997, T2c, T2b));
        T29 = FNMS(KP500000000, T28, T21);
        Cr[WSCR(7)] = FMA(KP823639103, T2a, T29);
        Cr[WSCR(13)] = FNMS(KP823639103, T2a, T29);
        T2j = FNMS(KP500000000, T2i, T2h);
        Cr[WSCR(2)] = FNMS(KP823639103, T2k, T2j);
        Cr[WSCR(8)] = FMA(KP823639103, T2k, T2j);
      }
      {
        ...
        Ci[WSCI(9)] = MUL(KP951056516, SUB(Tv, TK));
        Cr[WSCR(9)] = ADD(T1h, T1M);
        Ci[WSCI(6)] = MUL(KP951056516, SUB(TN, TO));
        Cr[WSCR(6)] = ADD(T1R, T1U);
        Ci[WSCI(11)] = MUL(KP951056516, FNMS(KP910592997, T1Q, T1P));
        Ci[WSCI(4)] = MUL(KP951056516, FMA(KP910592997, T1Y, T1X));
        Ci[WSCI(14)] = MUL(KP951056516, FNMS(KP910592997, T1Y, T1X));
        Ci[WSCI(1)] = MUL(KP951056516, FMA(KP910592997, T1Q, T1P));
        T1N = FNMS(KP500000000, T1M, T1h);
        Cr[WSCR(1)] = FMA(KP823639103, T1O, T1N);
        Cr[WSCR(11)] = FNMS(KP823639103, T1O, T1N);
        T1V = FNMS(KP500000000, T1U, T1R);
        Cr[WSCR(4)] = FMA(KP823639103, T1W, T1V);
        Cr[WSCR(14)] = FNMS(KP823639103, T1W, T1V);
      }
    }
  }
}
