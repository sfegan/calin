/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cb.native -n 40 -sign 1 -standalone -fma -generic-arith -compact -name dft_codelet_hc2r_40 */
 ...
 */
void dft_codelet_hc2r_40(R * R0, R * R1, const R * Cr, const R * Ci)
{
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    
    {
      ...
      }
      {
        ...
        R0[WSR(10)] = FNMS(KP2_000000000, TE, Tl);
        R0[WSR(15)] = FMA(KP2_000000000, T3y, T3x);
        R0[0] = FMA(KP2_000000000, TE, Tl);
        R0[WSR(5)] = FNMS(KP2_000000000, T3y, T3x);
      }
      {
        E T3p, T3v, T3u, T3w;
        {
        ...
        R1[WSR(12)] = FNMS(KP1_414213562, T3u, T3p);
        R1[WSR(7)] = FMA(KP1_414213562, T3w, T3v);
        R1[WSR(2)] = FMA(KP1_414213562, T3u, T3p);
        R1[WSR(17)] = FNMS(KP1_414213562, T3w, T3v);
      }
      {
        ...
        }
        {
          ...
          R0[WSR(2)] = FNMS(KP2_000000000, T1s, T15);
          R0[WSR(12)] = FMA(KP2_000000000, T1s, T15);
          T2F = FNMS(KP2_000000000, T1w, T1v);
          R0[WSR(13)] = FNMS(KP2_000000000, T2G, T2F);
          R0[WSR(3)] = FMA(KP2_000000000, T2G, T2F);
          T2R = FNMS(KP2_000000000, T14, TT);
          R0[WSR(17)] = FNMS(KP2_000000000, T2S, T2R);
          R0[WSR(7)] = FMA(KP2_000000000, T2S, T2R);
          T1x = FMA(KP2_000000000, T1w, T1v);
          R0[WSR(18)] = FNMS(KP2_000000000, T1A, T1x);
          R0[WSR(8)] = FMA(KP2_000000000, T1A, T1x);
        }
        {
          E T2d, T2C, T2J, T2O;
          T2d = FNMS(KP2_000000000, T2c, T21);
          T2C = SUB(T2e, T2B);
          R1[WSR(10)] = FNMS(KP1_414213562, T2C, T2d);
          R1[0] = FMA(KP1_414213562, T2C, T2d);
          T2J = FNMS(KP2_000000000, T2I, T2H);
          T2O = SUB(T2K, T2N);
          R1[WSR(14)] = FNMS(KP1_414213562, T2O, T2J);
          R1[WSR(4)] = FMA(KP1_414213562, T2O, T2J);
        }
        {
          E T2P, T2Q, T2D, T2E;
          T2P = FMA(KP2_000000000, T2I, T2H);
          T2Q = ADD(T2K, T2N);
          R1[WSR(9)] = FNMS(KP1_414213562, T2Q, T2P);
          R1[WSR(19)] = FMA(KP1_414213562, T2Q, T2P);
          T2D = FMA(KP2_000000000, T2c, T21);
          T2E = ADD(T2e, T2B);
          R1[WSR(5)] = FNMS(KP1_414213562, T2E, T2D);
          R1[WSR(15)] = FMA(KP1_414213562, T2E, T2D);
        }
      }
      {
        ...
        }
        {
          ...
          R0[WSR(14)] = FNMS(KP2_000000000, T1S, T1L);
          R0[WSR(4)] = FMA(KP2_000000000, T1S, T1L);
          T39 = FNMS(KP2_000000000, T1W, T1V);
          R0[WSR(1)] = FNMS(KP2_000000000, T3a, T39);
          R0[WSR(11)] = FMA(KP2_000000000, T3a, T39);
          T3l = FNMS(KP2_000000000, T1K, T1H);
          R0[WSR(9)] = FNMS(KP2_000000000, T3m, T3l);
          R0[WSR(19)] = FMA(KP2_000000000, T3m, T3l);
          T1X = FMA(KP2_000000000, T1W, T1V);
          R0[WSR(6)] = FNMS(KP2_000000000, T20, T1X);
          R0[WSR(16)] = FMA(KP2_000000000, T20, T1X);
        }
        {
          E T2X, T36, T3d, T3i;
          T2X = FNMS(KP2_000000000, T2W, T2T);
          T36 = SUB(T2Y, T35);
          R1[WSR(18)] = FNMS(KP1_414213562, T36, T2X);
          R1[WSR(8)] = FMA(KP1_414213562, T36, T2X);
          T3d = FMA(KP2_000000000, T3c, T3b);
          T3i = ADD(T3e, T3h);
          R1[WSR(1)] = FNMS(KP1_414213562, T3i, T3d);
          R1[WSR(11)] = FMA(KP1_414213562, T3i, T3d);
        }
        {
          E T3j, T3k, T37, T38;
          T3j = FNMS(KP2_000000000, T3c, T3b);
          T3k = SUB(T3h, T3e);
          R1[WSR(16)] = FNMS(KP1_414213562, T3k, T3j);
          R1[WSR(6)] = FMA(KP1_414213562, T3k, T3j);
          T37 = FMA(KP2_000000000, T2W, T2T);
          T38 = ADD(T2Y, T35);
          R1[WSR(13)] = FNMS(KP1_414213562, T38, T37);
          R1[WSR(3)] = FMA(KP1_414213562, T38, T37);
        }
      }
    }
  }
