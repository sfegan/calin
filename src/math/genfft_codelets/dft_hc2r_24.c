/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cb.native -n 24 -sign 1 -standalone -fma -generic-arith -compact -name dft_codelet_hc2r_24 */
 ...
 */
void dft_codelet_hc2r_24(R * R0, R * R1, const R * Cr, const R * Ci)
{
  ...
  DK(KP2_000000000, +2.000000000000000000000000000000000000000000000);
  {
    
    {
      ...
      }
      {
        ...
        To = ADD(Ti, Tn);
        R0[WSR(6)] = FNMS(KP2_000000000, To, Td);
        R0[0] = FMA(KP2_000000000, To, Td);
        T1F = FNMS(KP2_000000000, Tc, T7);
        T1G = SUB(T1z, T1A);
        R0[WSR(9)] = FNMS(KP2_000000000, T1G, T1F);
        R0[WSR(3)] = FMA(KP2_000000000, T1G, T1F);
        {
          ...
          T1C = SUB(T1y, T1B);
          T1E = ADD(T1y, T1B);
          R1[WSR(10)] = FNMS(KP1_414213562, T1C, T1x);
          R1[WSR(7)] = FMA(KP1_414213562, T1E, T1D);
          R1[WSR(4)] = FMA(KP1_414213562, T1C, T1x);
          R1[WSR(1)] = FNMS(KP1_414213562, T1E, T1D);
        }
      }
      {
        ...
        T1h = ADD(TP, TQ);
        R0[WSR(2)] = ADD(TR, TU);
        R0[WSR(11)] = ADD(T1h, T1i);
        R0[WSR(8)] = SUB(TR, TU);
        R0[WSR(5)] = SUB(T1h, T1i);
      }
      {
        ...
        T1t = ADD(Tv, TA);
        R0[WSR(10)] = ADD(TB, TM);
        R0[WSR(7)] = ADD(T1t, T1u);
        R0[WSR(4)] = SUB(TB, TM);
        R0[WSR(1)] = SUB(T1t, T1u);
      }
      {
        E T1l, T1r, T1q, T1s;
        {
        ...
        R1[WSR(8)] = FNMS(KP707106781, T1q, T1l);
        R1[WSR(11)] = FMA(KP707106781, T1s, T1r);
        R1[WSR(2)] = FMA(KP707106781, T1q, T1l);
        R1[WSR(5)] = FNMS(KP707106781, T1s, T1r);
      }
      {
        E T11, T1f, T1e, T1g;
        {
        ...
        R1[WSR(6)] = FNMS(KP707106781, T1e, T11);
        R1[WSR(3)] = FMA(KP707106781, T1g, T1f);
        R1[0] = FMA(KP707106781, T1e, T11);
        R1[WSR(9)] = FNMS(KP707106781, T1g, T1f);
      }
    }
  }
}
