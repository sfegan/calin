/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cf.native -n 32 -standalone -fma -generic-arith -compact -name dft_codelet_r2hc_32 */
 ...
 */
void dft_codelet_r2hc_32(const R * R0, const R * R1, R * Cr, R * Ci)
{
  ...
  DK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    
    {
      ...
      }
      {
        ...
        T2a = ADD(T28, T29);
        Cr[WSCR(8)] = SUB(Tf, Tu);
        Ci[WSCI(8)] = SUB(T29, T28);
        Cr[WSCR(16)] = SUB(T27, T2a);
        Cr[0] = ADD(T27, T2a);
      }
      {
        ...
        T24 = ADD(T1W, T23);
        T26 = SUB(T23, T1W);
        Cr[WSCR(12)] = FNMS(KP707106781, T24, T1P);
        Ci[WSCI(12)] = NEG(FNMS(KP707106781, T26, T25));
        Cr[WSCR(4)] = FMA(KP707106781, T24, T1P);
        Ci[WSCI(4)] = FMA(KP707106781, T26, T25);
      }
      {
        ...
        Cr[WSCR(14)] = FNMS(KP923879532, T2m, T2f);
        Ci[WSCI(14)] = NEG(FNMS(KP923879532, T2u, T2r));
        Cr[WSCR(2)] = FMA(KP923879532, T2m, T2f);
        Ci[WSCI(2)] = FMA(KP923879532, T2u, T2r);
        Ci[WSCI(6)] = NEG(FNMS(KP923879532, T2q, T2p));
        Cr[WSCR(6)] = FMA(KP923879532, T2w, T2v);
        Ci[WSCI(10)] = FMA(KP923879532, T2q, T2p);
        Cr[WSCR(10)] = FNMS(KP923879532, T2w, T2v);
      }
      {
        ...
        Cr[WSCR(15)] = FNMS(KP980785280, T1g, TH);
        Ci[WSCI(15)] = FMA(KP980785280, T1s, T1p);
        Cr[WSCR(1)] = FMA(KP980785280, T1g, TH);
        Ci[WSCI(1)] = NEG(FNMS(KP980785280, T1s, T1p));
        Ci[WSCI(7)] = FMA(KP980785280, T1o, T1n);
        Cr[WSCR(7)] = FMA(KP980785280, T1u, T1t);
        Ci[WSCI(9)] = NEG(FNMS(KP980785280, T1o, T1n));
        Cr[WSCR(9)] = FNMS(KP980785280, T1u, T1t);
      }
      {
        ...
        Cr[WSCR(13)] = FNMS(KP831469612, T1E, T1x);
        Ci[WSCI(13)] = NEG(FNMS(KP831469612, T1M, T1J));
        Cr[WSCR(3)] = FMA(KP831469612, T1E, T1x);
        Ci[WSCI(3)] = FMA(KP831469612, T1M, T1J);
        Ci[WSCI(5)] = NEG(FNMS(KP831469612, T1I, T1H));
        Cr[WSCR(5)] = FNMS(KP831469612, T1O, T1N);
        Ci[WSCI(11)] = FMA(KP831469612, T1I, T1H);
        Cr[WSCR(11)] = FMA(KP831469612, T1O, T1N);
      }
    }
  }
}
