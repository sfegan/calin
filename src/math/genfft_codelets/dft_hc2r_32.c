/* Generated by: /Users/sfegan/GitHub/fftw3/genfft/gen_r2cb.native -n 32 -sign 1 -standalone -fma -generic-arith -compact -name dft_codelet_hc2r_32 */
 ...
 */
void dft_codelet_hc2r_32(R * R0, R * R1, const R * Cr, const R * Ci)
{
  ...
  DK(KP2_000000000, +2.000000000000000000000000000000000000000000000);
  {
    
    {
      ...
      }
      {
        ...
        R0[WSR(8)] = FNMS(KP2_000000000, Tw, Th);
        R0[WSR(12)] = FMA(KP2_000000000, T2w, T2v);
        R0[0] = FMA(KP2_000000000, Tw, Th);
        R0[WSR(4)] = FNMS(KP2_000000000, T2w, T2v);
      }
      {
        ...
        T2s = SUB(T2o, T2r);
        T2u = ADD(T2o, T2r);
        R0[WSR(10)] = FNMS(KP1_414213562, T2s, T2n);
        R0[WSR(14)] = FMA(KP1_414213562, T2u, T2t);
        R0[WSR(2)] = FMA(KP1_414213562, T2s, T2n);
        R0[WSR(6)] = FNMS(KP1_414213562, T2u, T2t);
      }
      {
        E TR, T1j, T1i, T1k;
        {
        ...
        R1[WSR(8)] = FNMS(KP1_961570560, T1i, TR);
        R1[WSR(12)] = FMA(KP1_961570560, T1k, T1j);
        R1[0] = FMA(KP1_961570560, T1i, TR);
        R1[WSR(4)] = FNMS(KP1_961570560, T1k, T1j);
      }
      {
        E T2f, T2j, T2i, T2k;
        {
        ...
        R0[WSR(3)] = FNMS(KP1_847759065, T2i, T2f);
        R0[WSR(15)] = FMA(KP1_847759065, T2k, T2j);
        R0[WSR(11)] = FMA(KP1_847759065, T2i, T2f);
        R0[WSR(7)] = FNMS(KP1_847759065, T2k, T2j);
      }
      {
        E T1n, T1r, T1q, T1s;
        {
        ...
        R1[WSR(2)] = FNMS(KP1_662939224, T1q, T1n);
        R1[WSR(14)] = FMA(KP1_662939224, T1s, T1r);
        R1[WSR(10)] = FMA(KP1_662939224, T1q, T1n);
        R1[WSR(6)] = FNMS(KP1_662939224, T1s, T1r);
      }
      {
        E T1L, T1P, T1O, T1Q;
        {
        ...
        R1[WSR(3)] = FNMS(KP1_961570560, T1O, T1L);
        R1[WSR(15)] = FMA(KP1_961570560, T1Q, T1P);
        R1[WSR(11)] = FMA(KP1_961570560, T1O, T1L);
        R1[WSR(7)] = FNMS(KP1_961570560, T1Q, T1P);
      }
      {
        E T1Z, T2b, T2a, T2c;
        {
        ...
        R0[WSR(9)] = FNMS(KP1_847759065, T2a, T1Z);
        R0[WSR(13)] = FMA(KP1_847759065, T2c, T2b);
        R0[WSR(1)] = FMA(KP1_847759065, T2a, T1Z);
        R0[WSR(5)] = FNMS(KP1_847759065, T2c, T2b);
      }
      {
        E T1z, T1H, T1G, T1I;
        {
        ...
        R1[WSR(9)] = FNMS(KP1_662939224, T1G, T1z);
        R1[WSR(13)] = FMA(KP1_662939224, T1I, T1H);
        R1[WSR(1)] = FMA(KP1_662939224, T1G, T1z);
        R1[WSR(5)] = FNMS(KP1_662939224, T1I, T1H);
      }
    }
  }
}
