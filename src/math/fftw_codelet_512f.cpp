/*
   ...
   calin/math/fftw_codelet_512f.hpp -- Stephen Fegan -- 2025-10-19

   Container for FFTW codelets for AVX512 float
...
namespace calin::math::fftw_util {
   template class FFTWCodelet<calin::util::vcl::VCL512FloatReal>;
}
