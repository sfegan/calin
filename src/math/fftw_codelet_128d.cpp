/*
   ...
   calin/math/fftw_codelet_128d.hpp -- Stephen Fegan -- 2025-10-19

   Container for FFTW codelets for SSE double
...
namespace calin::math::fftw_util {
   template class FFTWCodelet<calin::util::vcl::VCL128DoubleReal>;
}
